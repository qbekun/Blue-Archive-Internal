...
#define MX_LOGIC_DATA_LEVELPROJECTILEENTITYDATA_SHOULDSERIALIZEABILITIES_OFFSET UNITYSDK_OFFSET(0x11FBF80)
#define MX_LOGIC_DATA_LEVELPROJECTILEENTITYDATA_.CTOR_OFFSET UNITYSDK_OFFSET(0x11FBF10)

namespace MX::Logic::Data
{
	inline static constexpr unsigned int LevelProjectileEntityData_TypeDefinitionIndex = 13709;

	class LevelProjectileEntityData : public Il2CppObject
	{
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + MX_LOGIC_DATA_LEVELPROJECTILEENTITYDATA_SHOULDSERIALIZEABILITIES_OFFSET))(nullptr);
		}

		::System::Void .ctor()
		{
			((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MX_LOGIC_DATA_LEVELPROJECTILEENTITYDATA_.CTOR_OFFSET))(nullptr);
		}
