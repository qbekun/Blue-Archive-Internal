...
#define MX_LOGIC_DATA_DAMAGEDLIMITEFFECTDATA_.CTOR_OFFSET UNITYSDK_OFFSET(0x11F3F60)

namespace MX::Logic::Data
{
	inline static constexpr unsigned int DamagedLimitEffectData_TypeDefinitionIndex = 13575;

	class DamagedLimitEffectData : public Il2CppObject
	{
	public:
		...
		::System::Void .ctor()
		{
			((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MX_LOGIC_DATA_DAMAGEDLIMITEFFECTDATA_.CTOR_OFFSET))(nullptr);
		}
