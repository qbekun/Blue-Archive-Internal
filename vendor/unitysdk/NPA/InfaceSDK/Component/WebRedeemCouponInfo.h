...
{
	inline static constexpr unsigned int WebRedeemCouponInfo_TypeDefinitionIndex = 25932;

	class WebRedeemCouponInfo : public Il2CppObject
	{
	public:
		::System::String* regionId; // 0x10
		::System::String* regionName; // 0x18
