...
namespace ui
{
    ...
    namespace tabs
    {
        void player(const TabCategory tab);
        void world(const TabCategory tab);
        void visual(const TabCategory tab);
        void config(const TabCategory tab);
    };
    ...
    namespace items
    {
        ...
        // Checkbox that fires a notification every time the value toggles.
        bool notify_checkbox(const char* label, bool* v);
    };
};