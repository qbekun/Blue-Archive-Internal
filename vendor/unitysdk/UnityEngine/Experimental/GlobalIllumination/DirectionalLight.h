...
{
	inline static constexpr unsigned int DirectionalLight_TypeDefinitionIndex = 31632;

	class DirectionalLight : public Il2CppObject
	{
	public:
		...
		::System::Single penumbraWidthRadian; // 0x54
